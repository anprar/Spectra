      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-white tracking-tight flex items-center space-x-3">
            <Award className="w-8 h-8 text-[#00d8f6]" />
        ...
        <a
          ...
          className="inline-flex items-center space-x-2 px-4 py-2 bg-[#0b0f19] hover:bg-slate-900 border border-slate-800 hover:border-slate-700 text-slate-300 hover:text-[#00d8f6] rounded-lg text-xs font-semibold transition-colors flex-shrink-0"
                    ...
                    <tr key={attempt.id} className="hover:bg-slate-900/30 transition-colors">
                      <td className="py-3.5 px-4">
                        <div className="flex flex-col">
                          <span className="font-semibold text-white">{attempt.candidate.fullName}</span>
                          <span className="text-[10px] text-slate-500 font-mono">{attempt.candidate.email}</span>
                        </div>
                      </td>
                      <td className="py-3.5 px-4">
                        <div className="flex flex-col">
                          <span className="font-semibold text-white max-w-xs truncate">{attempt.exam.title}</span>
