            ...
            <div key={q.id} className={`bg-[#0b0f19] border border-slate-800/80 rounded-xl p-6 shadow-md space-y-4 relative ${
              ...
              <div className="grid grid-cols-1 gap-3 pt-2">
                {options.map((opt) => {
                  ...
                  let optionStyle = 'border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950/20 text-slate-800 dark:text-slate-200';
                  let statusIcon = null;
                  ...
                  if (isSelected) {
                    if (q.isCorrect) {
                      ...
                      // Incorrect selection
                      optionStyle = 'bg-red-50 dark:bg-red-950/15 border-red-500 text-red-800 dark:text-red-300 font-semibold';
              ...
              {q.explanationSnapshot && (
                <div className="mt-4 p-4 bg-amber-50 dark:bg-[#030712] border border-amber-200 dark:border-slate-800 rounded-lg text-xs space-y-1.5">
